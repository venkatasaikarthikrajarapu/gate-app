...
types_code = """export type PriorityLevel = 'low' | 'medium' | 'high';
...
with open(os.path.join(base, "types.ts"), "w", encoding="utf-8") as f:
    f.write(types_code.strip() + "\n")
with open(os.path.join(base, "engine.ts"), "w", encoding="utf-8") as f:
    f.write(engine_code.strip() + "\n")
print("Scheduler skeleton generated successfully")
